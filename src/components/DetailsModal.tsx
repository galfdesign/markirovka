    ...
    <div className="details-modal-backdrop" onClick={onClose}>
      <div className="details-modal-window" onClick={e => e.stopPropagation()} style={{
        ...
        <div className="apple-card-field">
          <div style={{textAlign:'center', fontSize: '22px', fontWeight: 700, marginBottom: 18}}>
          ...
          <div className="details-grid">
            ...
            <div className="details-item">
              <label>Длина подводящих (м)</label>
              <input
                type="number"
                value={supplyLength}
            ...
            <div className="details-item">
              <label>Общая длина (м)</label>
              <input
                type="number"
                value={totalLength}
                disabled
                placeholder="Общая длина"
              />
            </div>
          </div>
          <div className="details-results" style={{
            ...
            <div style={{background:'#f5f6fa',borderRadius:7,padding:'6px 8px',minWidth:68,display:'flex',flexDirection:'column',alignItems:'center',fontSize:'13px'}}>
            ...
            <div style={{background:'#f5f6fa',borderRadius:7,padding:'6px 8px',minWidth:68,display:'flex',flexDirection:'column',alignItems:'center',fontSize:'13px'}}>
              ...
              <span className="metric-value" style={{fontSize:'11px',color:'#888',fontWeight:400}}>{results.regime}</span>
            </div>
          </div>
        </div>
        <div style={{display:'flex',gap:8,marginTop:16}}>
          <button className="apple-create-btn--centered" style={{width: '100%', background:'#0071e3'}} onClick={() => onSave({
            deltaT,
            supplyLength,
            innerDiameter,
          ...
          <button className="apple-create-btn--centered" style={{width: '100%', background:'#eee', color:'#222'}} onClick={onClose}>
            Отмена
          </button>
        </div>
      </div>
